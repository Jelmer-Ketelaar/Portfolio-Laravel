                ...
                <form action="{{ route('checkout') }}" method="POST" id="checkout-form">
                    <div class="row">
                        <div class="col-50">
                            ...
                            <label for="email"><i class="fa fa-envelope"></i> Email</label>
                            <input type="text" id="email" name="email" placeholder="jelmer@ketelaar.me" required>
                            <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
                            ...
                            <div class="row">
                                <div class="col-50">
                                    <label for="state">State</label>
                                    <input type="text" id="state" name="state" placeholder="Noord-Brabant" required>
                                </div>
                                <div class="col-50">
                                    <label for="zip">Zip</label>
                        ...
                        <div class="col-50">
                            ...
                            <label for="cname">Name on Card</label>
                            <input type="text" id="cname" name="cardname" placeholder="Jelmer Ketelaar" required>
                            <label for="ccnum">Credit card number</label>
                            ...
                            <div class="row">
                                <div class="col-50">
                                    <label for="expyear">Exp Year</label>
                                    <input type="text" id="expyear" name="expyear" placeholder="03/2023" required>
                                </div>
                                <div class="col-50">
                                    <label for="cvv">CVV</label>
...
@else <div class="container"> <h1>There are no items in your cart!</h1> </div>
@endif
